    ...
    public void eliminarVehiculo() {
        if (idSeleccionado != null) {
            try {
                ...
                setDatosCombo(servicio.obtenerDatosComboVehiculo());
                setIdSeleccionado(null);
                FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Vehículo eliminado con éxito", null));
            } catch (Exception e) {
                e.printStackTrace();
                FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Error al eliminar el vehículo", null));
            }
        } else {
            FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_WARN, "Seleccione un vehículo", null));
        }
    }
